...
// ===========TODAS AS IMAGENS USADAS NA PADARIA=======================================================================
    ...
    Texture2D fundo = LoadTexture("assets/padaria_principal.png");
    ...
    Texture2D fundoComprarPacotes = LoadTexture("assets/padaria_comprarpacotes.png");
    if (fundoComprarPacotes.id == 0) printf("[ERRO] Imagem comprar pacotes nao encontrada!\n");

    Texture2D fundoVenderFigurinhas = LoadTexture("assets/padaria_venderfigurinhas.png");
    if (fundoVenderFigurinhas.id == 0) printf("[ERRO] Imagem vender figurinhas nao encontrada!\n");

    Texture2D fundoTrocarFigurinhas = LoadTexture("assets/padaria_trocarfigurinhas.png");
...
void rodarMapa(Jogador *jogador) {
    ...
    while (!WindowShouldClose()) {
        ...
        if (IsMouseButtonPressed(MOUSE_LEFT_BUTTON) && mouseNaPadaria) {
            ...
            mapa = LoadTexture("assets/padaria_mapa.png");
